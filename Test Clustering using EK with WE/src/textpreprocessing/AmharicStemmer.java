...
public class AmharicStemmer {
	...
	private String sufword[]={"\u1279","\u12CE\u127D",/*"\u121D",*/"\u127D","\u12EB\u12CA",/*"\u1295",*/"\u12EC","\u12CE","\u1205","\u1238","\u12CB","\u127D\u1295","\u127D\u1295\u1295","\u1295","\u12CD","\u127D\u12CD",/*"\u12CD",*/ "\u1201","\u129D","\u1293","\u1208\u1275","\u120B\u1275","\u120B\u1278\u12CD","\u120B\u127D\u1201","\u1260\u1275","\u1263\u1275","\u1263\u1278\u12CD","\u1263\u127D\u1201",/*"\u1271","\u123D",*/"\u12ED\u1271","\u12CE\u1279","\u12E8\u12CD","\u129E\u127D",/*"\u129B",*/"\u129B\u12CD",/*"\u1278\u12CD"*/};
	private String preword[]={"\u12A5\u12E8","\u12EB\u1235","\u12EB\u120D","\u1232","\u12E8","\u12E8\u121A","\u12A8","\u1260","\u1208",/*"\u12ED",*/"\u12A5\u1295\u12F2","\u1235\u1208","\u12A5\u1235\u12AD","\u12A5\u1295\u12F0","\u12A5\u1235\u12AA","\u12A5\u1295\u12F5","\u12A8\u1290","\u12A5\u1295","\u12A5\u1290"};//"\u1275",
...
private boolean context(String affix,String str)
	{
		...
		if(str.length()>2)
		{
			...
			//else if(affix.equals("\u129E\u127D")) //the suffx nno C
                            else if(affix.equals("\u1230")) //the suffx nno C
...
//		FileInputStream fin = new FileInputStream(new File("C:/corpora1/mojo.txt"));
//		InputStreamReader read = new InputStreamReader(fin,"utf-16");
//		BufferedReader rd = new BufferedReader(read);
//		FileOutputStream fout = new FileOutputStream(new File("C:/corpora1/test/mojostemmed.txt"));
//     	        OutputStreamWriter rt = new OutputStreamWriter (fout,"utf-16");
//     	        BufferedWriter rtt = new BufferedWriter(rt);
//		String line;
